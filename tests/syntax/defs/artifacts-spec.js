...
`,'test_artifacts'	).errors[0].text).toContain("mismatched input ':'") });
...
artifacts:
  my_artifact:
    description: My beautiful artifact
    file: monfichier.doc
`,'test_artifacts'	).errors[0].text).toContain("No 'type' value provided") });
...
artifacts:
  my_artifact:
    description: My beautiful artifact
    type: tosca.artifacts.File
`,'test_artifacts'	).errors[0].text).toContain("No 'file' value provided") });
